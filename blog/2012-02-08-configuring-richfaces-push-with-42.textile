...
<span style="font-size: x-large;">Let’s start...</span>
...
<span style="font-size: x-large;">Creating the project stub</span>
...
<span style="font-size: x-large;">4 simple steps for Push</span>
...
<span style="font-size: x-large;">Installing Atmosphere libraries</span>
...
In order to install Atmosphere in your project, add following lines into your <span style="font-family: 'Courier New', Courier, monospace;">pom.xml</span>, in the section <span style="font-family: 'Courier New', Courier, monospace;"><dependencies></span>:
...
<blockquote class="tr_bq">**Note:** version of the dependency is automatically managed by importing the <span style="font-family: 'Courier New', Courier, monospace;">richfaces-bom</span>, that’s why you don’t need to specify <span style="font-family: 'Courier New', Courier, monospace;"><dependency><version></span> here.
<span style="font-size: x-large;">Registering PushServlet</span>
...
However in **Servlets 2.5 and lower**, servlet needs to be registered manually in <span style="font-family: 'Courier New', Courier, monospace;">web.xml</span>:
...
<span style="font-size: x-large;">Adding action to the managed bean</span>

Let’s open and edit <span style="font-family: 'Courier New', Courier, monospace;">RichBean.java</span> under <span style="font-family: 'Courier New', Courier, monospace;">src/main/java</span> in package you have defined. Add following methods:
...
<span style="font-size: x-large;">Adding component to the page</span>

Open and edit <span style="font-family: 'Courier New', Courier, monospace;">index.xhtml</span> file under <span style="font-family: 'Courier New', Courier, monospace;">src/main/webapp</span> directory.

Replace contents inside of <span style="font-family: 'Courier New', Courier, monospace;"><h:form></span> with following snippet:
...
<span style="font-size: x-large;">Accessing sample</span>
...
<blockquote class="tr_bq">Note: I know, this sample is quite artificial, because real-world applications won’t use a4j:push and updated area on the same page, but the purpose of the blog was mainly show you configuration of the RichFaces Push.
