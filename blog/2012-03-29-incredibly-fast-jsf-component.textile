...
There is&nbsp;<a href="https://github.com/richfaces/sandbox/tree/develop/hot-deployment"><span style="font-size: large;">guide</span></a>&nbsp;which covers how to setup **your tooling** to start with a development.
