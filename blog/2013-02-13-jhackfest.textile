...
"Developer Conference in Brno":http://devconf.cz/ will be held just in two weeks. Since it will highly increase a concentration of hackers and people which are fond of the open source, we will leverage *a fantastic opportunity to organize a hackfest*!

Last year we already organized "a hackfest":https://plus.google.com/109501071933862146039/posts/dyo3hU9smcj with a focus on the testing and "the event was very successful":http://lukas.fryc.eu/blog/2012/02/wrap-up-arquillian-hackfest-developer.html.

This year we are opening the hackfest to any project and ideas related to *Java and JVM languages (groovy, scala, clojure, ceylon, jruby, javascript, ...), frameworks or tools*.

h2. Occassion

The hackfest will take place *Februry 23-24th* ("conference days":http://developerconference2013.sched.org/grid-full), close to conference rooms and labs, in a *meeting room B431* (pavilion B, 4th floor).
...
We can then continue hacking on *Monday 25th in "Red Hat Office, Brno":http://goo.gl/maps/gIv9y*.

h2. Hackers & Mentors

* Would you like to hack on some *cool new features* for your project?
* Do you have *ideas* that would deserve to be pushed further?
...
The hackfest will be held near the conference, so *feel free to move to interesting talks or labs and come back again* - it depends on cooperation and agreement with your team.

We will have access to an internet connection, a projector, a chart, a big table and two small tables, some refreshments, etc.
